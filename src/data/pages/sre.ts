...
export const Sre_DATA: CoPPageData = {
  ...
  certStages: [
    { num: 1, title: 'Trained',      subtitle: 'Foundation training completed',           count: 3,      totalCohort: 10, color: '#16a34a', bg: '#dcfce7', border: '#86efac', desc: 'Members who have completed foundational SRE / Automation training.' },
    { num: 2, title: 'Intermediate', subtitle: 'Intermediate certification in progress',  count: 0,      totalCohort: 10, color: '#2563eb', bg: '#dbeafe', border: '#93c5fd', desc: 'Members pursuing intermediate SRE / Automation certification.' },
    { num: 3, title: 'Certified',    subtitle: 'Full certification achieved',              count: 7,      totalCohort: 10, color: '#A100FF', bg: '#F5E6FF', border: '#d8b4fe', desc: 'Members holding full SRE / Automation certification — domain champions.' },
  ],
  spotlight: {
    title: 'Top SME',
