...
export const Insurance_DATA: CoPPageData = {
  ...
  certStages: [
    { num: 1, title: 'Trained',      subtitle: 'Foundation training completed',           count: 457,    totalCohort: 15, color: '#16a34a', bg: '#dcfce7', border: '#86efac', desc: 'Members who have completed foundational Insurance training.' },
    { num: 2, title: 'Intermediate', subtitle: 'Intermediate certification in progress',  count: 334,    totalCohort: 15, color: '#2563eb', bg: '#dbeafe', border: '#93c5fd', desc: 'Members pursuing intermediate Insurance certification.' },
    { num: 3, title: 'Certified',    subtitle: 'Full certification achieved',              count: 2,      totalCohort: 15, color: '#A100FF', bg: '#F5E6FF', border: '#d8b4fe', desc: 'Members holding full Insurance certification — domain champions.', detail: 'AINS 101 · AINS 102 · AINS 103' },
  ],
  spotlight: {
    title: 'Top SME',
